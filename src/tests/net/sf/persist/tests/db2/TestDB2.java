...
package net.sf.persist.tests.db2;
...
public class TestDB2 extends TestSimple {
	...
	public String getProperties() {
		return "net/sf/persist/tests/db2/db2.properties";
	}
	...
	public void testStringTypes() throws SQLException {
		...
		Class[] longStringTypes = new Class[] { String.class, char[].class, Character[].class, Reader.class };
		...
		BeanMap beanMap = new BeanMap("StringTypes")
			...
			.addField( new FieldMap("longVarcharCol").setTypes(longStringTypes).setSize(16384).setSupportsQueryByValue(false) )
	...
	public void testBinaryTypes() throws SQLException {
		...
		Class[] byteTypes = new Class[] { byte[].class, };
		...
		BeanMap beanMap = new BeanMap("BinaryTypes")
			...
			.addField( new FieldMap("longVarcharBitCol").setTypes(binaryTypes).setSize(255).setSupportsQueryByValue(false) )
...
//			.addField( new FieldMap("longVargraphicCol").setTypes(binaryTypes).setSize(16384).setSupportsQueryByValue(false))
